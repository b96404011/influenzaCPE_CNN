...
X = np.load('influ_selected_input.npy')
Y = np.load('influ_selected_outputdim2.npy')
...
filepath="influ_0816_filter_model1-{epoch:02d}-valacc_{val_acc:.2f}.hdf5"
...
model.save_weights('0816_influ_filter_model1.h5')
model.save('0816_influ_filter_model_1')
...
plt.savefig("model_1_loss")

plt.savefig("model_1_loss.pdf")
...
plt.savefig("model_1_acc")

plt.savefig("model_1_acc.pdf")
